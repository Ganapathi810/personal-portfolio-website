                ...
                <div className="flex justify-evenly mb-2 lg:mb-8 mt-6">
                    <a href={websiteLink} target='_blank' rel='noopener noreferrer'>
                        <motion.button
                            ...
                            className=' text-slate-950 font-semibold border-black shadow-lg shadow-violet-900 hover:bg-violet-700 bg-violet-500 w-40 h-10 rounded-full transition-colors duration-200'
                        >
                            Try it
                        </motion.button>
                    </a>
                    <div className='rounded-full mt-0.5'>
                        <a href={githubLink} target='_blank' rel='noopener noreferrer'>
                            <svg className='h-8 w-8 sm:h-9 sm:w-9 fill-current stroke-slate-900 hover:stroke-violet-600 transition-colors duration-200' stroke='currentColor' strokeWidth='0.5' xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 24 24" id="github">
