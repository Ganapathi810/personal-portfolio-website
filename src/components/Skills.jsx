...
export const Skills = () => {
  ...
  const SKILL_ICONS = [
    ...
    },
    {
      ...
      direction : 'forward',
      icons : [
        <FaDocker className='size-9 sm:size-10 md:size-12 dark:fill-blue-500 fill-blue-700'/>,
      ],
      initial : { x : '-100%'},
      animate : {
        x : '890%'
  ...
  return (
      <div id='skills' className="relative z-20  pt-2 md:pt-2 mt-10 xl:mt-24 md:mt-2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className='w-full absolute left-0 -bottom-20 sm:-bottom-24 md:-bottom-28 lg:-bottom-32 xl:-bottom-36'>
          <defs>
