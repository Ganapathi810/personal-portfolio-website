    ...
    return (
        <div id='about' className='block lg:flex lg:justify-between pt-32 md:pt-40 w-full min-h-screen relative z-10'> 
            <motion.div 
                ...
                >
                    I am a <span className='text-blue-700 dark:text-blue-500 italic'>graduate</span> from <span className='text-blue-700 dark:text-blue-500 italic'>JNTUH College of Engineering Sultanpur</span> with a degree in <span className='text-blue-700 dark:text-blue-500 italic'>Computer Science and Engineering</span>. I graduated in mid-2024 and am seeking opportunities as a <span className='text-blue-700 dark:text-blue-500 italic'>Full-Stack Developer/Software engineer</span>. I specialize in building <span className='text-blue-700 dark:text-blue-500 italic'>responsive</span> and <span className='text-blue-700 dark:text-blue-500 italic'>dynamic</span> web applications using the <span className='text-blue-700 dark:text-blue-500 italic'>MERN stack (MongoDB, Express.js, React, and Node.js)</span>.

                    I have <span className='text-blue-700 dark:text-blue-500 italic'>hands-on experience</span> with <span className='text-blue-700 dark:text-blue-500 italic'>Firebase Authentication</span> and <span className='text-blue-700 dark:text-blue-500 italic'>Amazon S3</span> for storage and <span className='text-blue-700 dark:text-blue-500 italic'>Motion</span> animation library for creating smooth, interactive UI animations.. Currently, I am <span className='text-blue-700 dark:text-blue-500 italic'>expanding my skills</span> by learning <span className='text-blue-700 dark:text-blue-500 italic'>TypeScript</span> and <span className='text-blue-700 dark:text-blue-500 italic'>PostgreSQL</span> and I’m also <span className='text-blue-700 dark:text-blue-500 italic'>familiar</span> with <span className='text-blue-700 dark:text-blue-500 italic'>high-level system design</span> and <span className='text-blue-700 dark:text-blue-500 italic'>containerization using Docker.</span>
